...
if (inputRG != null && inputCPF.addEventListener) {                   
    inputRG.addEventListener("keypress", function(){mascaraTexto(this, '######################')});
} else if (inputRG != null && inputRG.attachEvent) {                  
    inputRG.attachEvent("onkeypress", function(){mascaraTexto(this, '######################')});
}
